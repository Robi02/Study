...
set IN_MSG_FILE_PATH=../res/input/35350081.180404104958
set OUT_MSG_FILE_PATH=../res/output/cli/35350081.180404104958.rpy
set OUT_LOG_FILE_PATH=../res/output/cli/fbclilog.log
