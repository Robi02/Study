...
<body>
    <div class="d-flex justify-content-center align-items-center" style="height:500px;">
		<table>
			...
			<!-- 환율 변환 버튼 -->
			<tr>
				<td colspan="3" align="center"><input type="button" class="btn btn-info btn-block" value="환율 변환" onclick="requestJsonpResult()"></td>
			</tr>
			<!-- 반올림 체크박스 -->
			<tr>
	...
	<!-- JavaScript for ajax -->
	<script src="view/jsonp/js/jsonp.js"></script>
</body>
</html>