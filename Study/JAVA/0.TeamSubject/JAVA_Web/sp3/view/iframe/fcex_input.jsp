...
<body>
	...
	<div id="inputPage" align="center">
		<div class="d-flex justify-content-center align-items-center" style="height:500px;">
			<form action="./iframe/result" method="GET" target="resultPage">
				<table>
					<!-- 타이틀 -->
					<tr>
	...
	<!-- iframe 결과창 -->
	<iframe id="resultPage" name="resultPage" src="./iframe/result" width="100%" height="0" frameBorder="0">></iframe>
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
    <script src="/resources/js/jquery331.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="/resources/js/bootstrap.min.js"></script>
	<!-- JavaScript for iframe -->
	<script src="/sp3/view/iframe/js/iframe.js"></script>
</body>
</html>