...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center" style="height:500px;">
		<table>
			...
			<!-- 환율 변환 버튼 -->
			<tr>
				<td colspan="3" align="center"><input type="button" class="btn btn-info btn-block" value="환율 변환" onclick="ajaxFcexResult(false)"></td>
			</tr>
			<!-- 환율 변환 버튼 (크로스 도메인) -->
			<tr>
				<td colspan="3" align="center"><input type="button" class="btn btn-info btn-block" value="환율 변환 (Cross Domain)" onclick="ajaxFcexResult(true)"></td>
			</tr>
			<!-- 반올림 체크박스 -->
			<tr>
